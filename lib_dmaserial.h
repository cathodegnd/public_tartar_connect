...
#define DMA_SERIAL_RX_BUFFER_LENGTH		(300)	/**< Receiver buffer length */
#define DMA_SERIAL_TX_BUFFER_LENGTH 		(300)	/**< Transmit buffer length */
...
public:
	...
	uint8_t txBufferIsAvailable(void);
	/**
